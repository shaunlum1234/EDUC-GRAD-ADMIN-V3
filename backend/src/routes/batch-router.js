...
//Batch Routes
router.get('/*',passport.authenticate('jwt', {session: false}, undefined), getBatchInfoAPI);
router.post('/*',passport.authenticate('jwt', {session: false}, undefined), postBatchInfoAPI);
router.delete('/*',passport.authenticate('jwt', {session: false}, undefined), deleteBatchInfoAPI);
