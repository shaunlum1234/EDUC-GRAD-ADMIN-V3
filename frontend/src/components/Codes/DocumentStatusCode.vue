<template>
  <div>
    <p>A student's Transcript, Student Achievement Report (TVR) and Certificate(s) will show a status as the student progresses through the system.  The list of document statuses are maintained in this table.  Documents will show In Progress until the student graduates, once a student graduates and the final documents are created, the documents will show a status of Completed. If, and only if, the "Undo Completion" process is performed on a student will a student's existing documents get Archived. </p>
    <DisplayTable
