...
export default {
  ...
  methods: { 
    ...
    newBatchJob() {
      let batchDetail = { details: {what: "", who: "", credential: "", where: "", copies: "1", psiYear: this.getCurrentPSIYear()}, students: [{}], schools:[{}], districts: [{}], programs:[{}],blankTranscriptDetails:[{}],blankCertificateDetails:[{}]};
