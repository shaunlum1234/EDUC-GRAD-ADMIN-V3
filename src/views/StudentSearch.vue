              ...
              <b-card-text>
                <form v-on:submit.prevent>
                  <div class="form-group">
                    ...
                    <div class="search-results-message my-4">
                      <strong
                        ><span v-if="searchByPenMessage">{{
                          searchByPenMessage
                        }}</span></strong
                      >
                    </div>
                ...
                <form v-on:submit.prevent>
                    ...
                    <div class="row my-3">
                      <div class="advanced-search-field col-12 col-md-2">
                        ...
                        <div
                          href="#"
                          v-on:click="
                            advancedSearchInput.legalLastName.contains = !advancedSearchInput
                      ...
                      <div class="advanced-search-field col-12 col-md-2">
                        ...
                        <div
                          href="#"
                          v-on:click="
                            advancedSearchInput.legalFirstName.contains = !advancedSearchInput
                      ...
                      <div class="advanced-search-field col-12 col-md-2">
                        ...
                        <div
                          href="#"
                          v-on:click="
                            advancedSearchInput.legalMiddleNames.contains = !advancedSearchInput
                              .legalMiddleNames.contains
                          "
                          v-bind:class="{
                            active:
                    ...
                    <div class="row">
                      <div class="advanced-search-field col-12 col-md-2">
                        ...
                        <div
                          href="#"
                          v-on:click="
                            advancedSearchInput.usualLastName.contains = !advancedSearchInput
                              .usualLastName.contains
                          "
                          v-bind:class="{
                      ...
                      <div class="advanced-search-field col-12 col-md-2">
                        ...
                        <div
                          href="#"
                          v-on:click="
                            advancedSearchInput.usualFirstName.contains = !advancedSearchInput
                              .usualFirstName.contains
                          "
                          v-bind:class="{
                      ...
                      <div class="advanced-search-field col-12 col-md-2">
                        ...
                        <div
                          href="#"
                          v-on:click="
                            advancedSearchInput.usualMiddleNames.contains = !advancedSearchInput
                      ...
                      <div
                        class="advanced-search-field form-group col-12 col-md-2"
                        :class="{
                          'form-group--error':
                            $v.advancedSearchInput.mincode.value.$error,
                        }"
                      >
                        ...
                        <div
                          class="error"
                          v-if="!$v.advancedSearchInput.mincode.value.numeric"
                        >
                  ...
                  <div class="row">
                    <div class="search-results-message my-4 col-12 col-md-8">
                      <strong
                        ><span v-if="advancedSearchMessage">{{
                    ...
                    <div class="results-option-group col-12 col-md-4">
                      ...
                      <b-form-select
                        ...
                        v-if="totalPages > 1"
                        @change="advancedSearchPagination(1, resultsPerPage)"
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      <template #cell(pen)="data">
                        <router-link
                          :to="'/student-profile/' + data.item.pen"
                    ...
                    >
                      <ul class="pagination">
                        <li v-if="selectedPage != 1 && selectedPage >= 5">
                          <a
                            class="page-link"
                            href="#"
                            v-on:click="
                              advancedSearchPagination(1, resultsPerPage)
                            "
                            >First</a
                          >
                        </li>
                        ...
                        >
                          <a
                            v-if="paginationRange(index)"
                            class="page-link"
                            href="#"
                            v-on:click="
                              advancedSearchPagination(index, resultsPerPage)
                            "
                            >{{ index }}</a
                          >
                        </li>
            ...
            if (key == "mincode") {
              ...
              if (!isNaN(obj[key].value) === false) {
                ...
                if (obj[key].value.length >= 1 && obj[key].value.length <= 7) {
                  ...
                  this.advancedSearchMessage +=
                    "mincode must be between 1-8 digits. ";
                  isValid = false;
                }
              }
